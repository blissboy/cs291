...
function fillScene() {
    ...
    //let grassTexture = new THREE.TextureLoader().load('media/img/cs291/textures/grass512x512.jpg');
    let grassTexture = THREE.ImageUtils.loadTexture('media/img/cs291/textures/grass512x512.jpg');
